...
const BOOST_PACKAGES = [
  ...
  { name: "Power Boost - Premium placement for 7 days", duration: 7, price: "£11.99", priceId: "price_1TLlERAc5QcTT3aL8KbbVNwA", description: "Top placement in search results for 7 days" },
