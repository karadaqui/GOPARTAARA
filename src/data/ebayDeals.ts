...
export const EBAY_DEALS: EbayDeal[] = [
  ...
  { id: 'dacia', type: 'brand', brand: 'Dacia', label: 'Dacia Parts', discount: 'At least 10% off', description: 'Sandero, Duster, Jogger parts', expiryDate: null, url: 'https://www.ebay.co.uk/e/motors/m-deals-dacia?mkcid=1&mkrid=710-53481-19255-0&siteid=3&campid=5339148333&toolid=20014&customid=partara&mkevt=1' },
