...
const FEED_URL = `https://productdata.awin.com/datafeed/download/apikey/${AWIN_API_KEY}/language/en/fid/32377/columns/aw_deep_link,product_name,search_price,brand_name,merchant_image_url,merchant_category,in_stock,merchant_name,merchant_id,currency/format/csv/delimiter/%7C/compression/gzip/`
