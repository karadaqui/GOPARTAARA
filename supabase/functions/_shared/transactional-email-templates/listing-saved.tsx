    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={content}>
          <Heading style={h1}>Your Listing Got Saved! 🔖</Heading>
          <Text style={text}>
            Someone saved your listing <strong>"{listingTitle || 'your part'}"</strong> to their wishlist. This means there's interest in your part!
          </Text>
...
export const template = {
  component: ListingSavedEmail,
  subject: (data: Record<string, any>) => `Someone saved your listing "${data.listingTitle || 'part'}"!`,
  displayName: 'Listing saved notification',
