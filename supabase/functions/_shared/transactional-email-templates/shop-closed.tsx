...
const ShopClosedEmail = ({ name, reason }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your {SITE_NAME} seller account has been closed</Preview>
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={content}>
          <Heading style={h1}>Your Seller Account Has Been Closed</Heading>
          <Text style={text}>
            Hi {name || 'there'},
          </Text>
          <Text style={text}>
            Your {SITE_NAME} seller account and all associated listings have been closed by our moderation team.
          </Text>
          {reason && (
          ...
          <Text style={text}>
            If you believe this was done in error, you have the right to appeal. Please contact us:
          </Text>
          <Text style={text}>
            • Email: info@gopartara.com{'\n'}
            • Contact form: gopartara.com/contact
          </Text>
          <Text style={text}>
...
export const template = {
  component: ShopClosedEmail,
  subject: 'Your PARTARA seller account has been closed',
  displayName: 'Shop closed by admin',
  previewData: { name: 'John', reason: 'Repeated policy violations after multiple warnings.' },
